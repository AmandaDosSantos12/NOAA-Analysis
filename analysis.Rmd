...
```{r}
keeps <- c("astronomical low tide", "avalanche", "blizzard", "coastal flood", 
             "cold/wind chill", "extreme cold/wind chill", "dense fog", 
             "dense smoke", "drought", "dust devil", "dust storm", 
             "excessive heat", "flash flood", "flood", "lakeshore flood", 
             "funnel cloud", "freezing fog", "heat", "hail", "heavy rain", 
...
NOAAdata <- subset(NOAAdata, EVTYPE %in% keeps)
...
c("astronomical low tide", "avalanche", "blizzard", "coastal flood", "cold/wind chill", "extreme cold/wind chill",
  "dense fog", "dense smoke", "drought", "dust devil", "dust storm", "excessive heat", "flash flood", "flood",
  "lakeshore flood", "funnel cloud", "freezing fog", "heat", "hail", "heavy rain", "heavy snow", "high surf",
  "high wind", "hurricane", "ice storm", "lake-effect snow", "lightning", "marine hail", "marine high wind",
